...
//en lugar de poner el dao en component scan lo pongo en enable(no hay clases para instanciar)
...
public class ModeloConfig {
	...
	//Los siguientes metodos tienen nombre concreto para que los busque spring(antes era el que quisieramos)
